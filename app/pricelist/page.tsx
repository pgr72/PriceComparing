  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="container mx-auto px-4 py-8">
        <div className="mb-8">
          <h2 className="text-3xl font-bold mb-2">Current Prices</h2>
          <p className="text-gray-600">
            Compare prices across stores and find the best deals on groceries
          </p>
        </div>
          ...
          {(!groupedPrices || Object.keys(groupedPrices).length === 0) && (
            <Card>
              <CardContent className="py-12 text-center">
                <p className="text-gray-500">No prices available yet.</p>
                <p className="text-sm text-gray-400 mt-2">
                  Check back soon for updated pricing information.
                </p>
              </CardContent>
            </Card>
          )}
